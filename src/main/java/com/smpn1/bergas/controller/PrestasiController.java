...
public class PrestasiController {
    ...
    public ResponseEntity<CommonResponse<Prestasi>> add(Prestasi prestasi,
    ...
    public ResponseEntity<CommonResponse<Page<Prestasi>>> listAllPrestasi(
        ...
        try {
            Page<Prestasi> prestasiPage = prestasiService.findAllWithPaginationByUserId(
                    userId,
                    pageable);

            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(prestasiPage);
            response.setMessage("Prestasi list retrieved successfully.");
    ...
    public ResponseEntity<CommonResponse<Page<Prestasi>>> listAllPrestasiTerbaru(
        ...
        try {
            ...
            if (search.isEmpty()) {
                beritaPage = prestasiService.getAllTerbaru(userId, pageable);
            } else {
                beritaPage = prestasiService.searchPrestasi(userId, search, pageable);
            }
    ...
    public ResponseEntity<CommonResponse<Prestasi>> get(@PathVariable("id") long id)
    ...
    public ResponseEntity<CommonResponse<Prestasi>> updatePrestasi(@PathVariable("id") Long id,
            @RequestBody Prestasi prestasi) throws SQLException, ClassNotFoundException {
        CommonResponse<Prestasi> response = new CommonResponse<>();
        try {
