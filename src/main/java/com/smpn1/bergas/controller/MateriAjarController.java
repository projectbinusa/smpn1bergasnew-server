...
@RestController
@RequestMapping("/api/materi_ajar")
@CrossOrigin(origins = "*")
public class MateriAjarController {
    ...
    public ResponseEntity<CommonResponse<MateriAjar>> add(MateriAjar materiAjar,
    ...
    public ResponseEntity<CommonResponse<Page<MateriAjar>>> listAllMateriAjar(
        ...
        try {
            Page<MateriAjar> materiAjarPage = materiAjarService.findAllWithPaginationByUserId(
                    userId,
                    pageable);

            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(materiAjarPage);
            response.setMessage("MateriAjar list retrieved successfully.");
            ...
            response.setCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
            response.setData(null);
            response.setMessage("Failed to retrieve materi ajar list: " + e.getMessage());
    ...
    public ResponseEntity<CommonResponse<Page<MateriAjar>>> listAllMateriAjarTerbaru(
        ...
        try {
            ...
            Page<MateriAjar> beritaPage = materiAjarService.getAllTerbaru(userId,pageable);
            response.setStatus("success");
            response.setCode(HttpStatus.OK.value());
            response.setData(beritaPage);
            response.setMessage(" MateriAjar list retrieved successfully.");
    ...
    public ResponseEntity<CommonResponse<MateriAjar>> get(@PathVariable("id") long id)
    ...
    public ResponseEntity<CommonResponse<MateriAjar>> updateMateriAjar(@PathVariable("id") Long id,
            @RequestBody MateriAjar prestasi) throws SQLException, ClassNotFoundException {
        CommonResponse<MateriAjar> response = new CommonResponse<>();
        try {
