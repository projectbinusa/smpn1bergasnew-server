...
public class ProgramController {
    ...
    public ResponseEntity<CommonResponse<Program>> updateProgram(@PathVariable("id") Long id, @RequestBody Program program) throws SQLException, ClassNotFoundException {
        CommonResponse<Program> response = new CommonResponse<>();
        try {
