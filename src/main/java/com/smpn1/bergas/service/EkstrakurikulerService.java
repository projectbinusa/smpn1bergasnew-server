...
public class EkstrakurikulerService {
    ...
    public Ekstrakurikuler add(Ekstrakurikuler ekstrakurikuler) throws Exception {
        ...
        ekstrakurikuler.setUserId(
                securityUtil.getCurrentUserId());

        ekstrakurikuler.setUserName(
    ...
    public Page<Ekstrakurikuler> findAllWithPaginationByUserId(
            Long userId,
            Pageable pageable) {
        return ekstrakurikulerRepository.findByUserIdOrderByUpdatedDateDesc(
                userId,
                pageable);
    }

    public Page<Ekstrakurikuler> getAllTerbaru(Long userId, Pageable pageable) {
        return ekstrakurikulerRepository.findByUserIdOrderByCreatedDateDesc(userId, pageable);
    }
